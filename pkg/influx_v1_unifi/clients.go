...
func (u *InfluxV1Unifi) batchClient(r report, s *unifi.Client) { // nolint: funlen
...
func (u *InfluxV1Unifi) batchClientDPI(r report, v any, appTotal, catTotal totalsDPImap) {
