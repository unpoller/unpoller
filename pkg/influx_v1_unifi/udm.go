...
func (u *InfluxV1Unifi) batchSysStats(s unifi.SysStats, ss unifi.SystemStats) map[string]any {
	m := map[string]any{
...
func (u *InfluxV1Unifi) batchUDMtemps(temps []unifi.Temperature) map[string]any {
...
func (u *InfluxV1Unifi) batchUDMstorage(storage []*unifi.Storage) map[string]any {
	output := make(map[string]any)
...
func (u *InfluxV1Unifi) batchUDM(r report, s *unifi.UDM) { // nolint: funlen
