...
func (u *InfluxV1Unifi) batchUSG(r report, s *unifi.USG) {
...
func (u *InfluxV1Unifi) batchUSGstats(ss unifi.SpeedtestStatus, gw *unifi.Gw, ul unifi.Uplink) map[string]any {
	if gw == nil {
...
func (u *InfluxV1Unifi) batchUSGwans(r report, tags map[string]string, wans ...unifi.Wan) {
...
func (u *InfluxV1Unifi) batchNetTable(r report, tags map[string]string, nt unifi.NetworkTable) {
	for _, p := range nt {
		tags := map[string]string{
			"device_name": tags["name"],
			"site_name":   tags["site_name"],
